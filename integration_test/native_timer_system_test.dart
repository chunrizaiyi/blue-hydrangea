...
void main() {
  ...
  for (var iteration = 1; iteration <= _repetitions; iteration++) {
    testWidgets(
      'C-05 screen-off native countdown ($iteration/$_repetitions)',
      (tester) async {
        expect(
        ...
        try {
          ...
          final errorMs = completedAt is num
              ? completedAt.toInt() - endAt
              : null;
          debugPrint(
